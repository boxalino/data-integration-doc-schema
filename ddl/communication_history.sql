CREATE OR REPLACE TABLE `{{ YOUR_PROJECT }}.{{ YOUR_DATASET }}.communication_history_{{ F|D }}_{{ YYYYMMDD }}` (
	...
	last_visitor_id STRING OPTIONS(description="the visitor cookie id from Boxalino (can be null)"),
